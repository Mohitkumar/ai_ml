...
class Model:
    ...
    def optimize(self, X, Y, num_iterations=100, learning_rate=0.009, beta1 = 0.9, beta2 = 0.999, epsilon = 1e-8,print_cost=False):
        ...
        for i in range(num_iterations):
            ...
            if i % 100 == 0:
                if print_cost:
                    ...
                    print("iteration={}, cost={:.2f}, accuracy={:.2f}%".format(i, cost, accuracy))       
